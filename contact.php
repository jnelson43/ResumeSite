...
if($antispam == $solution) {
  ...
  try {
      ...
      $mail->addAddress('info@youneedjamesnelson.com');     // Add a recipient
  ...
  <article>
    ...
    <section>
      ...
      <p>If for whatever reason you believe this message was not sent correctly, feel free to email me directly at info@youneedjamesnelson.com</p>
  ...
  <article>
    ...
    <section>
      ...
      <p>This message was not sent correctly, feel free to email me directly at info@youneedjamesnelson.com</p>
      <form action='index.html'>
       <button class="btnSuccess">Home</button>
     </form>
   </section>
